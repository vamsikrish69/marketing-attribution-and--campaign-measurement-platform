...
SELECT
    ...
    LINEAR_ATTRIBUTED_CONVERSIONS AS TOTAL_LINEAR_ATTRIBUTED_CONVERSIONS,
    ROUND(LINEAR_ATTRIBUTED_REVENUE, 2) AS TOTAL_LINEAR_ATTRIBUTED_REVENUE,
    ROUND(LINEAR_ROAS, 2) AS LINEAR_ROAS,
    ROUND(COST_PER_LINEAR_ATTRIBUTED_CONVERSION, 2) AS COST_PER_LINEAR_ATTRIBUTED_CONVERSION
FROM MARKETING_ATTRIBUTION_DB.ANALYTICS.FCT_CHANNEL_ATTRIBUTION
ORDER BY
